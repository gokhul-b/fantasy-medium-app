    ...
    <View className="rounded-t-3xl bg-white px-4 py-6">
      ...
      <View className="space-y-4">
        <View className="border-b border-gray-300 pb-2">
          ...
          <Text className="text-base font-pregular">gokhulb</Text>
        </View>
        <View className="border-b border-gray-300 pb-2">
          <Text className="text-gray-400 text-base">Email</Text>
          <Text className="text-base font-pregular">gokhulb2001@gmail.com</Text>
        </View>
        <View className="border-b border-gray-300 pb-2">
          <Text className="text-gray-400 text-base">Password</Text>
          <Text className="text-base font-pregular">*********</Text>
        </View>
      </View>
    </View>
  );
